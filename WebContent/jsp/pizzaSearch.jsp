...
<table class="mainTable">
	<tr>
		...
		<table width="780" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td colspan="3" class="pageTitle" align="center">Searched
				Pizzas
				<td>
			</tr>
			...
			<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="241">
							...
							<tr>
								...
								<table border="0" cellpadding="0" cellspacing="0" width="188">
									...
									<s:if test="userRole =='Consumer' || userRole =='Bpo'">
										<tr>
											<td>&nbsp;&nbsp;&nbsp;</td>
											<td align="left" valign="top"><img src="images/q.jpg"
												border="0" width="7" height="7" alt=""></td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="539">
							...
							<tr>
								...
								<table border="0" cellpadding="0" cellspacing="0" width="475">
									<s:if
										test="(vegPizzas == null || vegPizzas.size() == 0) && (nonVegPizzas == null || nonVegPizzas.size() == 0)">
										<tr>
											<td colspan="3" align="center" class="menu">No Pizza
											found</td>
										</tr>
									</s:if>
									<s:if test="vegPizzas != null && vegPizzas.size() > 0">
										<tr>
									...
									<s:if test="nonVegPizzas != null && nonVegPizzas.size() > 0">
										<tr>
				...
				<td width="220" valign="top"><s:if
					test="userRole == 'Consumer'">
					<table style="margin-top:15" border="0" cellpadding="0"
						...
						<tr>
							...
							<form action="searchPizza" method="post">
							<table width="188" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td colspan="3" class="menu" align="center">Search your
									favourite Pizza</td>
								</tr>
								<tr height="10">
									<td colspan="2" class="subHead" align="center" height="20"
										valign="middle"><s:radio
										list="#{'Name':'By Name','Content':'By Contents'}"
										value="Name" name="searchBy"></s:radio></td>
								</tr>
								<tr>
									<td colspan="3">&nbsp;</td>
								...
								<tr>
									<td colspan="3"><s:textfield name="key" maxlength="15" /></td>
								...
								<tr>
									<td colspan="3"><s:submit value="Search" /></td>

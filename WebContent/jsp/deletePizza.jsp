...
<table class="mainTable">
	<tr>
		...
		<table width="780" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td colspan="3" class="pageTitle" align="center">Delete Pizza
				<td>
			</tr>
								...
								<table border="0" cellpadding="0" cellspacing="0" width="475">
									...
									<s:iterator value="vegPizzas">
										<tr height='50'>
											...
											<td><a
												href="deletePizzaSave.action?deletedPizzaId=<s:property value="pizzaId"/>"><img
												src="images/delete2.png"></a></td>
										</tr>
									</s:iterator>
									<tr>

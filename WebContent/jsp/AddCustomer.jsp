...
function setMasking(){
	...
	$('input[name="loginData.userName"]').mask("?9999999999",{placeholder:""});
	$('input[name="addressInfo.zipCode"]').mask("?999999",{placeholder:""});

}

function findCustomerInfo(){
	var contactNo = $('input[name="loginData.userName"]').val();
	$.ajax({
          url : "addCutomer.action?contactNo="+ contactNo,
          type:"POST",
          dataType: "json",
...
<table class="mainTable">
	<tr>
		...
		<table width="780" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td colspan="3" class="pageTitle" align="center">Customer Information
				<td>
			</tr>
								...
								<table border="0" cellpadding="0" cellspacing="0" width="188">
									...
									<tr>
											...
											<td valign="top" class="news" height="25"><b><a
												href="addCustomer.action" class="leftMenu">Cofigure Customer
											Orders</a></td>
											<td>&nbsp;&nbsp;&nbsp;</td>
										</tr>
										<tr>
					...
					<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="539">
							...
							<tr>
								...
								<form action="addCustomerSave" method="post">
								<table cellpadding="0" cellspacing="0">
									<tr>
										<td><b><s:text name="createCustomer.Instructions" /></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
									</tr>
									...
									<!-- COntact No -->
									<!--<tr>
										<td colspan="2" align="center"><a href="#" onclick="findCustomerInfo()">Find customer info of this number</a></td>
									</tr>
									--><tr>
										<td><s:textfield id="contactNo" name="loginData.userName"
											key="createCustomer.contactNo.label" required="true"
											requiredposition="left" maxlength="25" /></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
									...
									<tr>
										<td><s:submit type="button" value="Proceed to Configure Order" /></td>
									</tr>
								</table>

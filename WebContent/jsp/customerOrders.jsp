		...
		<table width="780" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<s:if test="userRole=='Bpo'">
					<td colspan="3" class="pageTitle" align="center">Customer
					Orders
					<td>
				</s:if>
				<s:else>
					<td colspan="3" class="pageTitle" align="center">Order History
						...
						<table border="0" cellpadding="0" cellspacing="0" width="539">
							...
							<tr>
								...
								<table border="0" cellpadding="0" cellspacing="0" width="475">
									...
									<s:iterator value="pizzaOrderDatas">
										<tr height='50'>
											<td align="center"><a
												href="orderDetail.action?orderId=<s:property value="orderId" />"><s:property
												value="orderId" /></a></td>
											<td><s:property value="orderCreationDate" /></td>
											<td><s:property value="status" /></td>
											<s:if test="status=='Placed' && userRole == 'Bpo'">
												<td><a
													href="completeOrder.action?orderId=<s:property value="orderId" />">Complete
												Order</a></td>
											</s:if>
										</tr>
									</s:iterator>
